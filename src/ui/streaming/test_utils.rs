...
/// Stricter helper function that directly compares all fields of fragments
pub fn assert_fragments_match_exact(expected: &[DisplayFragment], actual: &[DisplayFragment]) {
    assert_eq!(
        expected.len(),
        actual.len(),
        "Different number of fragments. Expected {}, got {}",
