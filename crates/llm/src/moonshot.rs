...
/// Moonshot AI request customizer
/// TODO: Determine which fields need to be stripped (if any)
pub struct MoonshotRequestCustomizer;

impl RequestCustomizer for MoonshotRequestCustomizer {
...
impl MoonshotClient {
    ...
    pub fn new(api_key: String, model: String, base_url: String) -> Self {
        ...
        let request_customizer = Box::new(MoonshotRequestCustomizer);
...
#[async_trait]
impl LLMProvider for MoonshotClient {
...
mod tests {
    ...
    #[test]
    fn test_moonshot_headers() {
        let customizer = MoonshotRequestCustomizer;
    ...
    #[test]
    fn test_moonshot_url_customization() {
        let customizer = MoonshotRequestCustomizer;
        ...
        assert_eq!(url_streaming, "https://api.moonshot.ai/v1/chat/completions");
    }
}
