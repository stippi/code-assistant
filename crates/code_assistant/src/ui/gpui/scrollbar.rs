...
use gpui::{
    hsla, point, px, quad, relative, Along, App, Axis as ScrollbarAxis, Bounds, ContentMask,
    Corners, Edges, Element, ElementId, Entity, EntityId, GlobalElementId, Hitbox, Hsla,
    IntoElement, LayoutId, MouseDownEvent, MouseMoveEvent, MouseUpEvent, Pixels, Point,
    ScrollHandle, ScrollWheelEvent, Size, Style, UniformListScrollHandle, Window,
};
...
impl Element for Scrollbar {
    ...
    fn paint(
        ...
        window.with_content_mask(Some(ContentMask { bounds }), |window| {
            let thumb_background = hsla(0., 0., 0.3, 1.);
