...
//! concrete syntax is spoken — native tool calling, XML, or Caret — is decided
//! once at agent construction by picking an implementation. The
//! implementations live with the tools (`crate::tools::parser_registry` for
//! now); only the native default is destined for the core crate.
