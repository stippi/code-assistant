...
pub struct PendingEdit {
    pub content: String,
    pub attachments: Vec<code_assistant_core::persistence::DraftAttachment>,
    pub branch_parent_id: Option<code_assistant_core::persistence::NodeId>,
}
    ...
    pub fn new() -> Self {
        ...
        Self {
            ...
            persisted_projects: Arc::new(Mutex::new(
                code_assistant_core::config::load_projects()
                    .unwrap_or_default()
                    .keys()
                    .cloned()
                    .collect(),
